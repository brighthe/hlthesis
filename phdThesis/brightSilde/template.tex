...
%		数值方法设计及其实现与应用}
	...
	\begin{frame}
		...
		\begin{tcolorbox}[
			...
			top=2pt, bottom=2pt, left=8pt, right=8pt]
			{\fontsize{7.5}{11}\selectfont\sffamily
				在相同单元类型与离散阶次下，进一步比较单元密度表征与节点密度表征，%
				考察其对边界表达与求解效率的影响。}
		\end{tcolorbox}
		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.55\linewidth}
				\begin{tcolorbox}[
					...
					\centering
					\includegraphics[width=0.88\linewidth,
					height=0.16\paperheight, keepaspectratio]{mbb_elemdensity_k4}
					\\[3pt]
					{\fontsize{7.5}{10}\selectfont\sffamily
						单元密度表征，$n=41,\; c=218.66$}
					...
					% 节点密度
					\includegraphics[width=0.88\linewidth,
					height=0.16\paperheight, keepaspectratio]{mbb_nodaldensity_k4}
					\\[3pt]
					{\fontsize{7.5}{10}\selectfont\sffamily
						节点密度表征，$n=500{+},\; c=216.04$}
			...
			\begin{column}{0.43\linewidth}
				...
				\begin{tcolorbox}[
					...
					\setlength{\parskip}{0pt}\sloppy
					{\fontsize{7.5}{11}\selectfont\sffamily
						 节点密度的 $C^0$ 连续性产生隐式平滑效应，无需额外过滤即可抑制阶梯边界。%
						 两者宏观骨架相近，但节点密度的局部过渡更平滑自然。}
				\end{tcolorbox}
				...
				\begin{tcolorbox}[
					...
					colbacktitle=structure.fg, coltitle=white,
					fonttitle=\fontsize{7.5}{10}\selectfont\bfseries\sffamily,
					title={\circnum{02}\enspace 空间约束与收敛效率的权衡},
					arc=3pt, boxrule=0.5pt,
					toptitle=1pt, bottomtitle=1pt,
					top=5pt, bottom=5pt, left=6pt, right=6pt]
					\setlength{\parskip}{0pt}\sloppy
					{\fontsize{7.5}{11}\selectfont\sffamily
						连续性特征限制了材料的极端跳跃分布，导致变量演化平缓、迭代步数显著增加}
				\end{tcolorbox}
	...
	\begin{frame}
		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.50\linewidth}
				\begin{tcolorbox}[
					colback=structure.fg!6, colframe=structure.fg,
					colbacktitle=structure.fg, coltitle=white,
					fonttitle=\fontsize{7.5}{10}\selectfont\bfseries\sffamily,
