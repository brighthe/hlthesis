		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.485\linewidth}
				\begin{tcolorbox}[
					...
					\begin{minipage}[t]{0.46\linewidth}
						\centering
						\includegraphics[width=\linewidth,
						height=0.20\paperheight, keepaspectratio]{topo_ana_k2}\\[2pt]
						{\fontsize{6}{8}\selectfont\sffamily\color{structure.fg!80}
							(a)\enspace $k=2$，$u_{\mathrm{dof}}=2562$}
					\end{minipage}%
					\hfill%
					\begin{minipage}[t]{0.46\linewidth}
						\centering
						\includegraphics[width=\linewidth,
						height=0.20\paperheight, keepaspectratio]{topo_ana_k4}\\[2pt]
						{\fontsize{6}{8}\selectfont\sffamily\color{structure.fg!80}
							(b)\enspace $k=4$，$u_{\mathrm{dof}}=9922$}
					\end{minipage}
					...
					% ── 图下注释 ────────────────────────────────────
					{\fontsize{6.5}{9}\selectfont\sffamily\color{structure.fg!70}
						同一设计自由度下，升阶主要增加分析规模，而未显著改变拓扑骨架。}
			...
			\begin{column}{0.485\linewidth}
				\begin{tcolorbox}[
					...
					% ── 图下注释 ────────────────────────────────────
					{\fontsize{6.5}{9}\selectfont\sffamily\color{structure.fg!70}
						分析自由度固定时，单方面提高设计分辨率会诱发明显的数值震荡与伪结构。}
...
%			arc=3pt, boxrule=0pt,
%			top=2pt, bottom=2pt, left=8pt, right=8pt]
%			{\fontsize{7.5}{11}\selectfont\sffamily\color{white}\bfseries
%				企校合作项目：中建五局三公司建筑结构力学计算内核研发}
%		\end{tcolorbox}
%		
%		\vspace{-1.5em}
%		
...
%					colbacktitle=structure.fg, coltitle=white,
%					fonttitle=\fontsize{7.5}{10}\selectfont\bfseries\sffamily,
%					title={\circnum{01}\enspace 基于 C++ 的高性能底层实现},
%					arc=3pt, boxrule=0.5pt,
%					toptitle=2pt, bottomtitle=2pt,
...
%							\textbf{工业级架构} &
%							全程采用 C++ 自研有限元计算内核，实现内存高效管理与算子高度复用，保障大规模工程算例的计算效率。\\[4pt]
%							\textbf{高性能组装} &
%							将博士课题成果落地，针对三维高阶单元实现张量化快速组装机制，大幅降低刚度矩阵构建的时间成本。\\[4pt]
%							\textbf{混合结构} &
%							算法有效支持梁、桁架、板壳等多种混合实体单元的耦合计算。\\
%						\end{tabular}\par}
%				\end{tcolorbox}
%				
%				\vspace{3pt}
...
%					colbacktitle=structure.fg, coltitle=white,
%					fonttitle=\fontsize{7.5}{10}\selectfont\bfseries\sffamily,
%					title={\circnum{02}\enspace 核心应用成效},
%					arc=3pt, boxrule=0.5pt,
%					toptitle=2pt, bottomtitle=2pt,
%					top=5pt, bottom=5pt, left=7pt, right=7pt]
%					\setlength{\parskip}{0pt}
...
%						\begin{tabular}{@{}r@{~~}p{0.78\linewidth}@{}}
%							\textbf{高精度评估} &
%							成功克服传统低阶单元精度瓶颈，解决复杂工况（如 L 型区域）的位移捕捉难题。\\[4pt]
%							\textbf{自主可控} &
%							验证了高阶有限元理论在实际工程中的可行性，摆脱对商业软件底层内核的依赖。\\[4pt]
%							\textbf{项目状态} &
%							成果已于 2024 年 1 月顺利通过中建五局验收。\\
%						\end{tabular}\par}
%				\end{tcolorbox}
%				
%			\end{column}
...
%					toptitle=2pt, bottomtitle=2pt,
%					top=6pt, bottom=6pt, left=6pt, right=6pt,
%					height=0.575\paperheight, valign=top]
%					\setlength{\parskip}{0pt}
%					
%					% 图 1（上）
%					\centering
%					\includegraphics[width=\linewidth,
%					height=0.22\paperheight, keepaspectratio]{fig41}
%					
%					\vspace{2pt}
%					{\fontsize{6.5}{9}\selectfont\sffamily\color{structure.fg!80}
%						图1\enspace L 型复杂区域位移仿真云图\par}
%					
%					\vspace{6pt}
%					{\color{structure.fg!20}\rule{\linewidth}{0.4pt}}
%					\vspace{6pt}
%					
%					% 图 2（下）
%					\includegraphics[width=\linewidth,
%					height=0.22\paperheight, keepaspectratio]{fig40}
%					
%					\vspace{2pt}
%					{\fontsize{6.5}{9}\selectfont\sffamily\color{structure.fg!80}
%						图2\enspace 三维高阶程序残余力收敛曲线\par}
%					
%				\end{tcolorbox}
%			\end{column}
%			
