...
\begin{document}
\title[High Order Edge and Face Elements]{Geometric Decomposition and Efficient Implementation of High Order Face and Edge Elements}
...
\author[Chen C Y, Chen L, Huang X H, Wei H Y]{Chunyu Chen \affil{1}, 
