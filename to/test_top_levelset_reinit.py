...
class TopLevelSet:
    """
    TopLevelSet class implements a level set method for topological optimization.
    """
    ...
    def optimize(self, Num: int = 200):
        ...
        visualize.plot_matrices(struc, lsf, 
                  titles=['Original structure (struc)', 'Signed distance function (lsf)'],
