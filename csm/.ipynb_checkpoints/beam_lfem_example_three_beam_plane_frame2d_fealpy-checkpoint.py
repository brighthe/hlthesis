...
from fealpy.fem.beam_structure_integrator import EulerBernoulliBeamStructureIntegrator
...
# Retrieving cross-sectional area, Young's modulus and moment of inertia
A = pde.A
E = pde.E
I = pde.I
...
bform.add_domain_integrator(EulerBernoulliBeamStructureIntegrator(E, I, A))
K = bform.assembly()
