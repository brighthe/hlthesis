...
\title{Adaptive finite element method for continuum damage fracture phase field model}
...
\author{ \href{https://orcid.org/0000-0000-0000-0000}{\includegraphics[scale=0.06]{orcid.pdf}\hspace{1mm}Liang He}\thanks{Use footnote for providing further
