...
\begin{enumerate} 
	\item \textbf{Tensor level}: Provides core tensor operations and manages backends via the \textit{Tensor Backend Manager}, supporting SOPTX's multi-backend switching. It also enables \textcolor{red}{AD} in PyTorch and JAX, simplifying sensitivity computations in topology optimization (TO).
